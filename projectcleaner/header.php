...
<body>
    ...
    <section id="header2">
        <a href="index.php"><img src="kepek/logo.PNG" width="150" height="40" class="logo "alt="Logo"></a>
    ...
    <section id="header">
        <div>
            <ul id="navbar">
                ...
                <li><a href="menpage.php">Férfi ruhák</a></li>
                <li><a href="womenpage.php">Női ruhák</a></li>
            </ul>
        </div>
        <div>   
            <ul id="navbar2">    
                <div class="dropdown-center">
                  <li class="nav-item dropdown dropdown-center">
                    ...
                    if ($authenticated) {
                    ?>
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?= $_SESSION["username"] ?></a>
                    ...
                    <div class="dropdown-menu rounded-0 border border-dark" aria-labelledby="navbarDropdown">
                        <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#loginModal">Bejelentkezés</button>
                      <?php } ?>
                      </div>
                    </li>
                </div>
                <li><a href="cart.php"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-bag" viewBox="0 0 16 16"><path d="M8 1a2.5 2.5 0 0 1 2.5 2.5V4h-5v-.5A2.5 2.5 0 0 1 8 1m3.5 3v-.5a3.5 3.5 0 1 0-7 0V4H1v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4zM2 5h12v9a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1z"/></svg></a></li>
            </ul>
        </div>
