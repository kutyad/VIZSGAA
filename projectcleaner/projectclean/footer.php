        ...
        <div class="container p-4">
          <div class="row">
            <div class="col-lg-4 col-md-12 mb-4 mb-md-0">
              ...
              <p><strong>Cím: </strong> Budapest, hatodik utca</p>
            ...
            <div class="col-lg-4 col-md-12 mb-4 mb-md-0">
              ...
              <p><a class="footerlinkek" href="cart.php">Kosár</a>
            </div>

            <div class="col-lg-4 col-md-12 mb-4 mb-md-0">
              <h5 class="text-uppercase">Vásárlás</h5>
              <p><a class="footerlinkek" href="no.php">Női</a></p>
              <p><a class="footerlinkek" href="ferfi.php">Férfi</a></p>
            </div>
          </div>
        </div>
    ...
    <footer class="mt-auto bg-black text-center">
        <div class="container p-4">
          <div class="row">
            ...
            <div class="col-lg-4 col-md-12 mb-4 mb-md-0">
              <h5 class="text-uppercase">FIÓKOM</h5>
              <p><a class="footerlinkek" href="registracion.php">Regisztráció</a></p>
              <p><a class="footerlinkek" href="kosar.html">Kosár</a>
            </div>
