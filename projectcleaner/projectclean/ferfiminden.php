      ...
      <div class="container mt-5">
        <div class="row">
          ...
          <div class="col-6 col-sm-6 col-md-6 col-lg-4 col-xl-3">
            <a href="productpage.php" class="cardslinkek">
            ...
            <a href="productpage.php" class="cardslinkek">
              <div class="card rounded-0">
                <div id="carousel2" class="carousel slide" data-bs-interval="false">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img src="manjackets.webp" class="d-block w-100 rounded-0" alt="Slide 1">
                    </div>
                    <div class="carousel-item">
                      <img src="manbanner.webp" class="d-block w-100 rounded-0" alt="Slide 2">
                    </div>
                    <div class="carousel-item">
                      <img src="womanbanner.jpg" class="d-block w-100 rounded-0" alt="Slide 3">
                    </div>
                  </div>
          ...
          <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3">
            <a href="ferfikabatok.html" class="cardslinkek">
              <div class="card rounded-0">
                <div id="termek2" class="carousel slide" data-bs-interval="false">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img src="manjackets.webp" class="d-block w-100 rounded-0" alt="Slide 1">
                    </div>
                  ...
                  <button class="carousel-control-prev" type="button" data-bs-target="#termek2" data-bs-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                  </button>
                  <button class="carousel-control-next" type="button" data-bs-target="#termek2" data-bs-slide="next">
                    <span class="carousel-control-next-icon" aria-hidden="true"></span>
                  </button>
                </div>
                <div class="card-text-box">
